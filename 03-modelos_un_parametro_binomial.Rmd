...
$$
donde $y = \sum_{i=1}^n y_i$. Esta expresión sugiere que $y$ es un **estadístico suficiente** para $\theta$ (i.e., $y$ contiene toda la información de los datos para hacer inferencia sobre $\theta$). 
...
\end{align*}
$$
donde $a$ y $b$ son los **hiperparámetros** (cantidades fijas conocidas) del modelo. 

Los hiperparámetros se eligen de tal forma que la distribución previa refleje el **estado de información externo** al conjunto de datos. 
...
La distribución predictiva posterior depende de los datos, mas **no depende** de cantidades desconocidas.
