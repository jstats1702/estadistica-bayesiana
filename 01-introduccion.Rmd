...
La **distribución muestral $p(y\mid\theta)$** es el mecanismo aleatorio que especifica cómo se genera $y$ dado un valor específico de $\theta$.
...
La **distribución previa $p(\theta)$** es el mecanismo aleatorio que especifica el estado de información acerca de $\theta$ externo al conjunto de datos $y$.
...
La **distribución posterior** $p(\theta\mid y)$ es el mecanismo aleatorio que especifica el estado de información actualizado acerca de $\theta$ después de observar $y$.
...
El teorema de Bayes establece **cómo debe cambiar el estado de información** acerca de $\boldsymbol{\theta}$ de acuerdon con la evidencia empírica que proporciona $\boldsymbol{y}$.
...
La **Teoría de la Probabilidad** es una parte de las Matemáticas que se dedica a la **cuantificación de la incertidumbre**.
