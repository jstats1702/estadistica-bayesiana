...
for (i in 1:m) 
  plot(x = 0:n, y = dbinom(x = 0:n, size = n, prob = theta[i]), type = "h", lwd = 4, col = 2, xlab = "y", ylab = "Densidad", main = bquote(theta==.(round(theta[i],2))), ylim = c(0, 0.4))
```
...
R. A. Fisher popularizó esta idea y la llamó **verosimilitud** (*likelihood*), 
$$
