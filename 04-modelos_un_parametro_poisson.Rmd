...
$$
p(\boldsymbol{y}\mid\theta) = \frac{1}{\prod_{i=1}^n y_i!}\,\theta^{s}e^{-n\theta}\,,
$$
...
Se tiene que $\theta$ (el objetivo inferencial) y $y^*$ (el objetivo predictivo) tienen la misma media posterior, pero la varianza posterior de $y^*$ es mayor:
$$
...
- Sea \( y \mid \theta \sim \textsf{Poisson}(\theta) \).  
     ...
     c. Obtenga la distribución posterior correspondiente y determine las condiciones sobre \( y \) que garantizan que esta distribución sea propia.
