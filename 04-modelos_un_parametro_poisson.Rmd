...
Esta distribución se conoce como **distribución Gamma Poisson** con parámetros $n\in\mathbb{N}$, $a>0$ y $b>0$, lo que se denota con $y\sim\textsf{Gamma-Poisson}(n,a,b)$. Esta distribución es un promedio ponderado (mezcla) de distribuciones Poisson, ponderadas por la distribución Gamma. 
