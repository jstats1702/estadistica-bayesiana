...
```{r, echo=F, fig.height = 6, fig.width = 12, fig.align='center'}
# Librerías
...
ggplot(trace_df, aes(x = Iteration)) +
  geom_point(aes(y = Mu), color = 4, size = 0.5, alpha = 0.5) +
  labs(title = "Mu", x = "Iteración", y = "Valor") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16)
  )
# Trazas para Sigma^2
ggplot(trace_df, aes(x = Iteration)) +
  geom_point(aes(y = Sigma2), color = 4, size = 0.5, alpha = 0.5) +
  labs(title = "Sigma²", x = "Iteración", y = "Valor") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16)
  )
# Trazas para Tau^2
ggplot(trace_df, aes(x = Iteration)) +
  geom_point(aes(y = Tau2), color = 4, size = 0.5, alpha = 0.5) +
  labs(title = "Tau²", x = "Iteración", y = "Valor") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16)
  )
